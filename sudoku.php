...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="SudokuServerSide/styles/stylesheet.css" rel="stylesheet" type="text/css" />
        <script type="text/javascript" src="SudokuServerSide/scripts/jquery-1.8.3.js"></script>
        <script type="text/javascript" src="SudokuServerSide/scripts/javascript-server-side.js"></script>
    </head>
        <?php
            require_once '/SudokuServerSide/includes/include_files.inc';
            global $gameArray;
